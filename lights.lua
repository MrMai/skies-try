...
function Lights:addLight(lx, ly, lsize, lr, lg, lb)
...
function Lights:drawLights(drawOccludersFn, coordTransX, coordTransY)
	for i = 1, #self.lightInfos do
		self:drawLight(drawOccludersFn, self.lightInfos[i], coordTransX, coordTransY)
	end
end
...
function Lights:drawLight(drawOccludersFn, lightInfo, coordTransX, coordTransY)
